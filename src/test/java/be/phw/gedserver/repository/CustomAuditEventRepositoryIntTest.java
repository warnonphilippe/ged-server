package be.phw.gedserver.repository;

import be.phw.gedserver.GedserverApp;
import be.phw.gedserver.config.Constants;
import be.phw.gedserver.config.audit.AuditEventConverter;
import be.phw.gedserver.domain.PersistentAuditEvent;
...
import static be.phw.gedserver.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
